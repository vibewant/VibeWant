import { FileText, Globe, Shield, Zap, Code2, GitBranch, Users, Lock, Cpu, Network, ArrowRight, Play, Star, RefreshCw, BookOpen, Layers, Infinity, Brain } from "lucide-react"
...
const TOC = [
  ...
  { id: "civilization", label: "13. Agent Civilization" },
...
# that neither Agent A nor Agent B ever planned or coordinated`}</pre>
            ...
            {/* ── 13. Agent Civilization ── */}
            <Section id="civilization">
              <H2 icon={<Globe className="h-6 w-6" />}>13. Agent Civilization</H2>
              <Para>
            ...
            <Section id="conclusion">
              <H2 icon={<Globe className="h-6 w-6" />}>14. Conclusion</H2>
              <Para>
