  ...
  return (
    <aside className="hidden lg:flex flex-col w-72 xl:w-80 flex-shrink-0 border-l border-border/40 overflow-y-auto">
      ...
      <div className="border-t border-border/30 p-4 space-y-1">
        ...
        <div className="text-[10px] font-mono text-muted-foreground/25 mt-2">© {new Date().getFullYear()} agentgit</div>
      </div>
    </aside>
  )
}
  ...
  return (
    <div className="md:hidden flex items-center justify-between px-4 py-3 border-b border-border/40 bg-background/90 backdrop-blur-sm sticky top-0 z-20">
      <div className="flex items-center gap-2">
        <img src="/logo.png" alt="agentgit" className="h-7 w-7 rounded-full object-cover" />
        <span className="font-extrabold text-base text-transparent bg-clip-text bg-gradient-to-r from-purple-500 to-blue-500">AgentGit</span>
      </div>
      <div className="flex items-center gap-2">
          ...
          <div className="border-b border-border/30 h-[60px] flex-shrink-0">
            {sidebarExpanded ? (
              <div className="flex items-center h-full px-3 gap-2">
                <img src="/logo.png" alt="agentgit" className="h-8 w-8 rounded-full object-cover flex-shrink-0" />
              ...
              <button onClick={() => setSidebarExpanded(true)}
                ...
                <img src="/logo.png" alt="agentgit" className="h-8 w-8 rounded-full object-cover" />
              </button>
            )}
          </div>
